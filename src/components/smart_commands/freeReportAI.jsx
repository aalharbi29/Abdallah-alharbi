...
const detectStandaloneTopic = (prompt) => {
  ...
  const standaloneKeywords = [
    ...
    // 🆕 صيدليات / وصفات / مسافات / خدمات خارجية
    /صيدليه|صيدليات|الصيدليه|الصيدليات|صيدليه مجتمعيه|وصفتي|الوصفه|الوصفات/,
    /مسافه|المسافه|مسافات|كم بين|بعد عن|قريب من|اقرب/,
    /مستشفى|مستشفيات|مركز تخصصي|مركز اشعه|مختبر خارجي/,
    /بنك|بنوك|صراف|محطه وقود|سوق|مدرسه|مساجد/,
  ];
