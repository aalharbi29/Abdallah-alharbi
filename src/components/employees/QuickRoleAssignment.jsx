...
const assignedTasksOptions = [
  ...
  { key: "منسق الزواج الصحي", label: "منسق الزواج الصحي", category: "الزواج الصحي" },
  { key: "مثقف صحي", label: "مثقف صحي", category: "الزواج الصحي" },
  { key: "موظف سحب العينة", label: "موظف سحب العينة", category: "الزواج الصحي" },
  { key: "الطبيب الاخصائي لعيادة المشورة", label: "الطبيب الاخصائي لعيادة المشورة", category: "الزواج الصحي" },
