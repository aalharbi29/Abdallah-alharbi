                    ...
                    {employee.المركز_الصحي && (
                      <Badge className="text-[10px] px-2 py-0.5 bg-emerald-500/20 text-emerald-200 max-w-full">
                        <span className="flex items-center gap-1 min-w-0">
                          ...
                          <span className="truncate">{getShortCenterName(employee.المركز_الصحي)}</span>
                        </span>
                      </Badge>
                    )}
                ...
                <div className="flex gap-1 shrink-0">
                  {onToggleSelection && (
                    <button
                      ...
                      className={`w-7 h-7 rounded-md border flex items-center justify-center ${isSelected ? 'bg-indigo-500 border-indigo-400' : 'border-white/30 bg-white/5'}`}
                    >
