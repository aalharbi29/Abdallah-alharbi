...
.logo-header{text-align:center;padding:25px 0 15px;border-bottom:2px solid #0f766e;margin-bottom:25px;}
.logo-header img{max-height:130px;margin:0 auto;display:block;}
...
<div class="page">
  ...
  <div class="footer-line">
    تم إنشاء هذا التقرير بواسطة نظام إدارة المراكز الصحية - الحسو
  </div>
</div>
</body>
</html>`;
