...
export const generateReportHtml = ({
  ...
  const approvalImageStyle = (type) => {
    ...
    return `width: ${size}px; height: auto; transform: translate(${approvalLayout[`${type}OffsetX`] || 0}px, ${approvalLayout[`${type}OffsetY`] || 0}px);`;
  };
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .narrative-greeting { font-family: '${fontSettings.narrativeGreeting.font}', 'Cairo', sans-serif; font-weight: ${fontSettings.narrativeGreeting.weight}; font-size: ${fontSettings.narrativeGreeting.size}px; display: block; line-height: 1.0; word-spacing: 0.1em; letter-spacing: 0.02em; margin-bottom: 20px; }
