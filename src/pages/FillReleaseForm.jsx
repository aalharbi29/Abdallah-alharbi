...
import { Printer, Download, Loader2, Stamp, PenTool, Move, Save, FolderOpen, Trash2 } from "lucide-react";
...
export default function FillReleaseForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    departmentName: "شؤون المراكز الصحية بالحناكية",
    senderName: "أ.عبدالمجيد سعود الريبقي",
    senderTitle: "مدير إدارة شؤون المراكز الصحية بالحناكية"
  });
      ...
      <div
        ...
        <div style={{ padding: '0 12mm', marginTop: '22mm' }}>
          ...
          <div style={{ fontSize: '15px', lineHeight: '2.2', fontFamily: 'Cairo,Arial', position: 'relative' }}>
            ...
            {/* Greeting - draggable */}
            <div
              style={{ transform: `translate(${lineOffsets.greeting.x}px, ${lineOffsets.greeting.y}px)`, cursor: draggingLine === 'greeting' ? 'grabbing' : 'grab', userSelect: 'none', marginBottom: '30px' }}
