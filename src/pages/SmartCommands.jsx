...
export default function SmartCommands() {
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      // استخدم مسار AI الكامل (planFreeReport) عند: الوضع الحر، أو طلب تجميعي، أو يوجد نص دون اختيار حقول يدوي
      // هذا يضمن أن فلاتر المراكز وأسماء الموظفين المذكورة في النص تُطبَّق فعلاً
