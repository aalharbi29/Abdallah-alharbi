            ...
            <tr style={{ position: 'relative' }}>
              <td style={{ width: '50%', padding: '10px', textAlign: 'right', verticalAlign: 'top' }}>
                              ...
                              <td style={{ width: '50%', padding: '10px', textAlign: 'left', verticalAlign: 'top' }}>
                                ...
                                <span className="editable-cell" contentEditable suppressContentEditableWarning onBlur={(e) => handleInputChange('managerApproval', e.currentTarget.textContent)} style={{ display: 'block', minHeight: '25px', padding: '4px' }}>
