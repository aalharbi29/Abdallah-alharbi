...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header-banner { border-bottom: 2px solid #87CEEB; padding: 0 0 8px; margin-bottom: 15px; overflow: hidden; display: flex; justify-content: ${logoJustify}; align-items: center; }
    ...
    th { background: #87CEEB; color: #000; border: 1px solid #87CEEB; padding: 10px 12px; text-align: center; font-weight: 700; font-size: 13px; }
    td { border: 1px solid #87CEEB; padding: 8px 12px; text-align: center; font-size: 13px; }
    ...
    .footer-banner { text-align: center; padding-top: 15px; border-top: 2px solid #87CEEB; margin-top: auto; }
