      ...
      >
        <div className="p-8">
          ...
          <div className="mb-6 flex justify-end items-center gap-3">
            ...
            <div className="w-14 h-14 bg-gradient-to-br from-green-600 to-green-800 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
          ...
          {/* Footer Info */}
          <div className="mb-4 px-3 py-2 text-sm rounded-lg border border-slate-300">
