...
const medicalEquipmentList = [
  ...
  { id: 'endotracheal_tube_children_adults', name: 'انبوب داخل الرغامي للاطفال والكبار', category: 'أجهزة طبية' },
  { id: 'tracheostomy_tube_cuffed', name: 'أنبوب فغر الرغامي مزود ببالون (كف)', category: 'أجهزة طبية' },
  { id: 'nasopharyngeal_airway_sizes', name: 'مجرى هواء أنفي بلعومي مقاسات 1.2.3.4', category: 'أجهزة طبية' },
